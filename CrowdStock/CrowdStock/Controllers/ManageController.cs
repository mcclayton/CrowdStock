...
namespace CrowdStock.Controllers
{
	...
	public class ManageController : Controller
	{
		...
		public ActionResult ChangeImage(string alert = null)
		{
			ViewBag.Alert = alert;
			return View();
		}
		...
		public ActionResult ImageUpload(HttpPostedFileBase file)
		{
			...
			if(file.ContentLength <= 0 || file.ContentLength > 1024 * 1024)
				return RedirectToAction("ChangeImage", new { alert = "Image must be less than 1MB" });

			if(!file.ContentType.Contains("image"))
				return RedirectToAction("ChangeImage", new { alert = "File must be an image." });
			...
			using(var db = new CrowdStockDBContext())
			{
				...
				userdata.ImageFileType = file.ContentType;
